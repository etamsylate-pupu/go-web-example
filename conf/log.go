...
func initAccessLog() *logrus.Logger {

	accessLog := initLog("access")

	return accessLog
}

func initServiceLog() *logrus.Logger {

	serviceLog := initLog("service")

	serviceLog.SetFormatter(serviceFormatter{})

	return serviceLog
}

func initMonitorLog() *logrus.Logger {

	serviceLog := initLog("socket")
